...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.fiap.am.coopfit.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do CoopFit",
				"Esta API é utilizada pelo grupo CoopFit para o Challenge do Sirio Libanes junto da FIAP.",
				"Versão 1.0", "", new Contact("Caio Cristóvão", "", "caiohcris@gmail.com"),
				"Permitido uso para estudantes e profissionais do Sirio Libanes", "", Collections.emptyList() // Vendor
																												// Extensions
		);
	}
